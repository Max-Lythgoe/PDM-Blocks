...
// Schema engine + PDM Settings page (loads only when PDM Accelerate theme is NOT active)
require_once plugin_dir_path(__FILE__) . 'includes/schema-engine/schema-engine-loader.php';
