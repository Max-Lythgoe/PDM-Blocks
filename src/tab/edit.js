...
export default function Edit( {
	...
	const blockProps = useBlockProps( {
		className: clsx(
			'pdm-tab',
			'pdm-tab-container',
			'pdm-tabs__' + parentAttrs.orientation,
			'pdm-tabs__' + parentAttrs.verticalPosition,
			'pdm-tabs-icon__' + parentAttrs.iconPosition
		),
	} );
