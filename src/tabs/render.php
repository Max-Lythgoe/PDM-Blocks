...
// Extract tabs data.
$all_tabs = pdm_tabs_extract_tab_data($block->parsed_block['innerBlocks'] ?? []);
...
$tabs_styles             = pdm_tabs_generate_styles($attributes);
$typography_classes      = pdm_tabs_get_typography_classes($attributes);
$typography_styles       = pdm_tabs_get_typography_styles($attributes);
$color_classes           = pdm_tabs_get_color_classes($attributes);
$border_classes          = pdm_tabs_get_border_color_classes($attributes);
$tabs_container_styles   = pdm_tabs_get_tabs_container_styles($attributes);
$tab_button_border_style = pdm_tabs_get_tab_button_border_styles($attributes);
...
$wrapper_classes = array_filter([
    'pdm-tabs',
    'pdm-tab-container',
    "pdm-tabs__{$orientation}",
    'pdm-tabs__' . ($attributes['verticalPosition'] ?? 'left'),
    ($justification === 'stretch' && $orientation === 'horizontal')
        ? 'pdm-tabs__autoWidth' : '',
    'pdm-tabs-icon__' . ($attributes['iconPosition'] ?? 'left'),
]);
...
<div <?php echo wp_kses_data($wrapper_attributes); ?>
    ...
    <ul class="pdm-tabs-buttons <?php echo esc_attr(trim($color_classes . ' ' . $border_classes)); ?>"
        role="tablist"
        ...
        ?>
            <li class="pdm-tab-btn"
                ...
                style="<?php echo esc_attr(!empty($attributes['tabBorder']['onActive']) ? '' : $tab_button_border_style); ?>">
