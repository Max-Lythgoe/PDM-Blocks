	...
	const colorControls = [
		{
			key: 'tabTextColor',
			state: tabTextColor,
			label: __( 'Tab Text', 'pdm-blocks' ),
		},
		{
			key: 'tabBackgroundColor',
			state: tabBackgroundColor,
			label: __( 'Tab Background', 'pdm-blocks' ),
		},
		{
			key: 'tabIconColor',
			state: tabIconColor,
			label: __( 'Tab Icon', 'pdm-blocks' ),
		},
	];
	...
	return (
		<>
			...
			<InspectorControls group="dimensions">
				<ToolsPanelItem
					label={ __( 'Tab Padding', 'pdm-blocks' ) }
					panelId={ clientId }
					isShownByDefault
